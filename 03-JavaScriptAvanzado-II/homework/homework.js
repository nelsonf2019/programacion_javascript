...
function getNombre() {
  return this.nombre; //this en este caso es el global pero no sabe a quien pertenece por eso usamos BIND
}
...
let getNombreInstructor = getNombre.bind(instructor);//Hace una closure, bind es una función
...
function crearCadena(delimitadorIzquierda, delimitadorDerecha,cadena) {
    return delimitadorIzquierda + cadena + delimitadorDerecha;
                                        ...
                                        //no hay this en la funcion, pero podemos poner this 
let textoAsteriscos = crearCadena.bind(null,"*","*");//Hace una closure, bind es una función que tieen otra funcion dentro como crearCadena que es una funcion
let textoGuiones = crearCadena.bind(null,"-","-");//
let textoUnderscore = crearCadena.bind(null,"_","_");
console.log(textoUnderscore(2))
